...
grep -q '"pending": 4' "$TMP/embedding-status.json"
grep -q '"processed": 4' "$TMP/embedding-rebuild.json"
grep -q '"pending": 0' "$TMP/embedding-status-after.json"
grep -q '"embedded": 4' "$TMP/embedding-status-after.json"
grep -q '"embeddable_records": 4' "$TMP/embedding-status-after.json"
grep -q '"indexed_records": 4' "$TMP/embedding-status-after.json"
grep -q '"fresh_records": 4' "$TMP/embedding-status-after.json"
