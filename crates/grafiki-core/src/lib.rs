...
pub use memory::{
    ...
    propose_capture_candidates, redact_json, redact_text, reject_candidate, run_capture_watch,
    ...
    ImportOptions, ImportReport, IngestCaptureEventOptions, ListAgentQueriesOptions,
    ...
    RelationListOptions, RunCaptureWatchOptions, SaveEntityOptions, SaveEntityReport,
    SearchMemoryOptions, SearchMode, SearchReport, SearchResult, SessionLogItem, SessionLogOptions,
    SessionLogReport, StartCaptureOptions, StateItem, StateListOptions, StateReport, StatusOptions,
    StatusReport, StopCaptureOptions, UpdateContextOptions, UpdateDecisionOptions,
