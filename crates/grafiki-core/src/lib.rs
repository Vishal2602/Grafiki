...
pub use memory::{
    ...
    propose_capture_candidates, redact_json, redact_text, reject_candidate, save_entity,
    ...
    CandidateMutationReport, CandidateReviewError, CaptureCandidateReport, CaptureEvent,
    CaptureEventReport, CaptureSession, CaptureSessionReport, CaptureStatusOptions,
    CaptureStatusReport, ContextDocument, ContextListOptions, ContextReport, ContextSummary,
    DecisionItem, DecisionListOptions, DecisionReport, DeleteContextOptions, DeleteDecisionOptions,
